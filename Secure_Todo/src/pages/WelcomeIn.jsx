...
function WelcomeIn({toggle}) {
  return (
     <div className=' flex justify-center items-center mx-[161px] my-[180px]  gap-[50px]'>
          ...
          <div  className=' w-[1050px] h-[350px] md-w-[200px] md:h-[200px]' >
              <img src="/img/img_todo.png" alt="todo_icon_img" />
          </div>
     
          <div className='  '>
               <p className=' text-[60px] font-bold w-[378px] h-[90px] mx-0.5 mb' >Welcome !</p>
               <p className=' text-[60px] font-bold w-[522px] h-[105px] ml-[65px] mt-4 '>Secure Notes...</p>
